...
#define AIFL_SPECIAL_FUNC       0x2000000   // prevent external interruption of current think func
#define AIFL_IN_COVER           0x4000000   // agent is currently in a cover position
//
// predict events
typedef enum
{
